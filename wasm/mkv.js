...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_matroska_video_info')) {
        Object.defineProperty(Module['ready'], '_get_matroska_video_info', { configurable: true, get: function() { abort('You are getting _get_matroska_video_info on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_matroska_video_info', { configurable: true, set: function() { abort('You are setting _get_matroska_video_info on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'mkv.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('mkv.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _get_matroska_video_info = Module["_get_matroska_video_info"] = createExportWrapper("get_matroska_video_info");
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 150684;
